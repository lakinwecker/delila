...
var _lakinwecker$delila$Utils$capitalize = function (name) {
...
var _lakinwecker$delila$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _lakinwecker$delila$Main$view = function (model) {
	var _p0 = model.page;
	if (_p0.ctor === 'Read') {
		return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('burger'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(_jystic$elm_font_awesome$FontAwesome$bars, _elm_lang$core$Color$black, 32),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('breadcrumbs'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Delila'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$name('search'),
													_1: {
														ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Hello Read'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('read'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('A bunch of text over and over and over. A bunch of text over and over and over. A bunch of text over and over and over. A bunch of text over and over and over. A bunch of text over and over and over. A bunch of text over and over and over. A bunch of text over and over and over. A bunch of text over and over and over. '),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Hello Splash'),
				_1: {ctor: '[]'}
			});
	}
};
var _lakinwecker$delila$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _lakinwecker$delila$Main$Model = function (a) {
	return {page: a};
};
var _lakinwecker$delila$Main$Read = {ctor: 'Read'};
var _lakinwecker$delila$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_lakinwecker$delila$Main$Model(_lakinwecker$delila$Main$Read),
	{ctor: '[]'});
var _lakinwecker$delila$Main$main = _elm_lang$html$Html$program(
	{init: _lakinwecker$delila$Main$init, view: _lakinwecker$delila$Main$view, update: _lakinwecker$delila$Main$update, subscriptions: _lakinwecker$delila$Main$subscriptions})();
var _lakinwecker$delila$Main$Splash = {ctor: 'Splash'};
var _lakinwecker$delila$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _lakinwecker$delila$Main$main !== 'undefined') {
    _lakinwecker$delila$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
Elm['Utils'] = Elm['Utils'] || {};
if (typeof _lakinwecker$delila$Utils$main !== 'undefined') {
    _lakinwecker$delila$Utils$main(Elm['Utils'], 'Utils', {"types":null,"versions":{"elm":"0.18.0"}});
}
